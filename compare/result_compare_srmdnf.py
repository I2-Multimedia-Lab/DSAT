...
def srmdnf(img, x1, y1, x2, y2):
    for img, x1, y1, x2, y2 in zip(img, x1, y1, x2, y2):
        image_path2 = '/home/lqg/code/results/manga109/srmdnf/1/'+str(img)+'_x4_.png'
        Simage_path = '/home/lqg/code/results/pic/manga1092/srmdnf/'+str(img)+'S.png'
        image2 = cv2.imread(image_path2)

        SRfirst_point = (x1, y1)
        SRlast_point = (x2, y2)
        cv2.imwrite(Simage_path, image2[y1:y2, x1:x2])
srmdnf(img, x1, y1, x2, y2)
