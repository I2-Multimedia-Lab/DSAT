...
parser.add_argument('--lambda_1', type=float, default=3.5,
...
parser.add_argument('--epochs_encoder', type=int, default=0,
                    help='number of epochs to train the degradation encoder')
parser.add_argument('--epochs_sr', type=int, default=1500,
...
parser.add_argument('--lr_decay_encoder', type=int, default=180,
                    help='learning rate decay per N epochs')
parser.add_argument('--lr_decay_sr', type=int, default=250,
                    help='learning rate decay per N epochs')
...
parser.add_argument('--resume', type=int, default=1066,
